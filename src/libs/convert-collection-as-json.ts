...
import type { DTCGCollection } from '../types';
...
import { type ReturnUniqueKeyIdMaps, uniqueKeyIdMaps } from './unique-key-id-maps';
...
export function convertCollectionAsJSON(
  ...
  const collection: DTCGCollection = variableIds
    .map((variableId) => {
